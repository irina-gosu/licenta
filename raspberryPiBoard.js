function raspberryPiBoard () {
	...
	this.pins[24] = new Pin (["GND"], "GND", -1);
	...
	this.pins[29] = new Pin (["GND"], "GND", 13);
	...
	this.pins[33] = new Pin (["GND"], "GND", -1);
	...
	this.pins[38] = new Pin (["GND"], "GND", -1);
