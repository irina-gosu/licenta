...
function raspberryPiBoard () {
	...
	this.pins[24] = new Pin (["OUT0"], "OUT0", -1, GND);
	...
	this.pins[29] = new Pin (["OUT0"], "OUT0", -1, GND);
	...
	this.pins[33] = new Pin (["OUT0"], "OUT0", -1, GND);
	...
	this.pins[38] = new Pin (["OUT0"], "OUT0", -1, GND);
